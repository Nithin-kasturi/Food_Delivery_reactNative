  ...
  return (
    // <View>
      ...
      <View className="rounded-t-3xl -mt-12 bg-white relative">
        ...
        <View  
          className="p-2 flex-row justify-between items-center rounded-full my-5 mx-2 bg-orange-200">
            ...
            <View className="flex-1 ml-3">
                <Text className="text-lg font-bold text-white">Chinnu Bhai</Text>
                <Text className="text-white font-semibold">Your Rider</Text>
            </View>
            <View  className="flex-row items-center space-x-3 mr-3">
              <TouchableOpacity className="bg-white p-2 rounded-full">
                <Icon.Phone fill={'orange'} stroke={'white'} strokeWidth="1" />
              </TouchableOpacity>
